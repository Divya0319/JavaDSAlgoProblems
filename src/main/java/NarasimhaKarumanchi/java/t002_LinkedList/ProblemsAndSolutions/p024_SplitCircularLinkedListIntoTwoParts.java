 ...
 */
public class p024_SplitCircularLinkedListIntoTwoParts<T> {
	...
	public static void main(String[] args) {
		p024_SplitCircularLinkedListIntoTwoParts<Integer> mainClass = new p024_SplitCircularLinkedListIntoTwoParts<>();

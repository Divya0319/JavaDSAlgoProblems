...
public class p045_RearrangeLinkedListWithOddAndEvenNumbers {
	...
	public static void main(String[] args) {
		p045_RearrangeLinkedListWithOddAndEvenNumbers mainClass = new p045_RearrangeLinkedListWithOddAndEvenNumbers();

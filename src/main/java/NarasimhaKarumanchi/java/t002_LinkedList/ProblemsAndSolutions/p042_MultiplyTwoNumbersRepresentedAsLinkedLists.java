...
public class p042_MultiplyTwoNumbersRepresentedAsLinkedLists {
	...
	public static void main(String[] args) {
		p042_MultiplyTwoNumbersRepresentedAsLinkedLists mainClass = new p042_MultiplyTwoNumbersRepresentedAsLinkedLists();

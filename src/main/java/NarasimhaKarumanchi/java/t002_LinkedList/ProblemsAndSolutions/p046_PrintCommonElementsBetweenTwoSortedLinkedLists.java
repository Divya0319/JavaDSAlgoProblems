...
public class p046_PrintCommonElementsBetweenTwoSortedLinkedLists {
	...
	public static void main(String[] args) {
		p046_PrintCommonElementsBetweenTwoSortedLinkedLists mainClass = new p046_PrintCommonElementsBetweenTwoSortedLinkedLists();

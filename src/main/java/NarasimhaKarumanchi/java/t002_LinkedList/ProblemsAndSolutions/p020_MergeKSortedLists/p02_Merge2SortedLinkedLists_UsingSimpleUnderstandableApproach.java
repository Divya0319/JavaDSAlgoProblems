...
public class p02_Merge2SortedLinkedLists_UsingSimpleUnderstandableApproach {
	...
	public static void main(String[] args) {
		...
		p02_Merge2SortedLinkedLists_UsingSimpleUnderstandableApproach mainClass =
				new p02_Merge2SortedLinkedLists_UsingSimpleUnderstandableApproach();

...
public class p027_ReverseKNodesOfBlockInLinkedList_Iterative<T> {
	...
	public static void main(String[] args) {
		p027_ReverseKNodesOfBlockInLinkedList_Iterative<Integer> mainClass = new p027_ReverseKNodesOfBlockInLinkedList_Iterative<>();

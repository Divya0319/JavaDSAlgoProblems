...
public class p01_RemoveDuplicatesFromUnorderedLinkedList_BruteForce {
	...
	public static void main(String[] args) {
		p01_RemoveDuplicatesFromUnorderedLinkedList_BruteForce mainClass = new p01_RemoveDuplicatesFromUnorderedLinkedList_BruteForce();

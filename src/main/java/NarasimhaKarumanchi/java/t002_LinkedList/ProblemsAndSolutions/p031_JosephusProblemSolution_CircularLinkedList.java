...
public class p031_JosephusProblemSolution_CircularLinkedList<T> {
	...
	public static void main(String[] args) {
		p031_JosephusProblemSolution_CircularLinkedList<Integer> mainClass = new p031_JosephusProblemSolution_CircularLinkedList<>();

...
public class p004_CheckIfLoopExistsInLinkedList_Floyds_algo<T> {
	...
	public static void main(String[] args) {
		p004_CheckIfLoopExistsInLinkedList_Floyds_algo<Integer> mainClass = new p004_CheckIfLoopExistsInLinkedList_Floyds_algo<>();

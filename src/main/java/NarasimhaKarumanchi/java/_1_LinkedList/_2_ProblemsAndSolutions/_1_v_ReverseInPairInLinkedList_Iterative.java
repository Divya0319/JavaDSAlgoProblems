...
public class _1_v_ReverseInPairInLinkedList_Iterative<T> {
	...
	public static void main(String[] args) {
		_1_v_ReverseInPairInLinkedList_Iterative<Integer> mainClass = new _1_v_ReverseInPairInLinkedList_Iterative<>();

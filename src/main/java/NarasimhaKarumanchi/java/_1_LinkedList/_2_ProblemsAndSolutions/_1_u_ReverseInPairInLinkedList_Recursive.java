...
public class _1_u_ReverseInPairInLinkedList_Recursive<T> {
	...
	public static void main(String[] args) {
		_1_u_ReverseInPairInLinkedList_Recursive<Integer> mainClass = new _1_u_ReverseInPairInLinkedList_Recursive<>();

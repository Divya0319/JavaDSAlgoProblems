...
public class _4_l_BottomViewOfBinaryTree {

	ArrayList<Integer> bottomView(BinaryTreeNode<Integer> root) {
		...
		try {
			...
			while(!q.isEmpty()) {
				...
				// if one value is present for a horizontal distance, we simply replace it
	...
	public static void main(String[] args) {
		_4_l_BottomViewOfBinaryTree mainClass = new _4_l_BottomViewOfBinaryTree();
		...
		System.out.println(mainClass.bottomView(root));
	}

...
public class _1_c_PrintLongestCommonSubsequence_UsingTabulation {	
	...
	public static void main(String[] args) {
		...
		_1_c_PrintLongestCommonSubsequence_UsingTabulation mainClass = new _1_c_PrintLongestCommonSubsequence_UsingTabulation();

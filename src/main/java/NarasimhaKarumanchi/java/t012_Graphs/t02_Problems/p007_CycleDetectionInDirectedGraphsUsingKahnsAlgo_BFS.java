...
public class p007_CycleDetectionInDirectedGraphsUsingKahnsAlgo_BFS {
	...
	public static void main(String[] args) {
		...
		p007_CycleDetectionInDirectedGraphsUsingKahnsAlgo_BFS mainClass = new p007_CycleDetectionInDirectedGraphsUsingKahnsAlgo_BFS();

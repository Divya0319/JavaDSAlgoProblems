...
public class p004_CycleDetectionInDirectedGraphsUsingDFS {
	...
	public static void main(String[] args) {
		...
		p004_CycleDetectionInDirectedGraphsUsingDFS mainClass = new p004_CycleDetectionInDirectedGraphsUsingDFS();

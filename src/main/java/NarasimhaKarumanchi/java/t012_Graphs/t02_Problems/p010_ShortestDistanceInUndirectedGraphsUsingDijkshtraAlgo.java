...
public class p010_ShortestDistanceInUndirectedGraphsUsingDijkshtraAlgo {
	...
	public static void main(String[] args) {
		...
		p010_ShortestDistanceInUndirectedGraphsUsingDijkshtraAlgo mainClass = new p010_ShortestDistanceInUndirectedGraphsUsingDijkshtraAlgo();

...
public class p005_CheckForBalancedBinaryTree_Optimised {
	...
	public static void main(String[] args) {
		p005_CheckForBalancedBinaryTree_Optimised mainClass = new p005_CheckForBalancedBinaryTree_Optimised();

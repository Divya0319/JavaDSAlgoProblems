...
public class p013_LeftViewOfBinaryTree {
	
	ArrayList<Integer> ans = new ArrayList<>();

	ArrayList<Integer> leftView(BinaryTreeNode<Integer> root) {
	...
	public static void main(String[] args) {
		p013_LeftViewOfBinaryTree mainClass = new p013_LeftViewOfBinaryTree();
		...
		System.out.println(mainClass.leftView(root));
	}

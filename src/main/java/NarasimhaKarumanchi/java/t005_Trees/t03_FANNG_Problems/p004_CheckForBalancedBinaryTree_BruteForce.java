...
public class p004_CheckForBalancedBinaryTree_BruteForce {
	...
	public static void main(String[] args) {
		p004_CheckForBalancedBinaryTree_BruteForce mainClass = new p004_CheckForBalancedBinaryTree_BruteForce();

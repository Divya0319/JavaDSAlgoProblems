...
public class p014_ArrayWithThreeStacks<T> {
	...
	public p014_ArrayWithThreeStacks(int size) {
		if(size < 3) {
	...
	public static void main(String[] args) {
		...
		p014_ArrayWithThreeStacks<String> awts = new p014_ArrayWithThreeStacks<>(10);
		awts.push(1, "Aman");

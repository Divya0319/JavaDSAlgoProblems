...
public class p026_RecursivelyRemoveAdjacentDuplicatesInArray {
	...
	public static void main(String[] args) {
		...
		p026_RecursivelyRemoveAdjacentDuplicatesInArray mainClass = new p026_RecursivelyRemoveAdjacentDuplicatesInArray();

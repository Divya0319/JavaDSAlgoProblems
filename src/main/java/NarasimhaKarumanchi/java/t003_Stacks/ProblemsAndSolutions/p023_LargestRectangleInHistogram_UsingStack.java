...
public class p023_LargestRectangleInHistogram_UsingStack {
	...
	public static void main(String[] args) {
		...
		p023_LargestRectangleInHistogram_UsingStack mainClass = new p023_LargestRectangleInHistogram_UsingStack();

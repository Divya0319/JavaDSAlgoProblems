...
public class p008_CheckStringGivenAsLinkedListIsPalindrome_UsingStack<T> {
	...
	public static void main(String[] args) {
		...
		p008_CheckStringGivenAsLinkedListIsPalindrome_UsingStack<Character> mainClass = new p008_CheckStringGivenAsLinkedListIsPalindrome_UsingStack<>();

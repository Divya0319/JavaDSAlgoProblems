...
public class p022_LargestRectangleInHistogram_BruteForce {
	...
	public static void main(String[] args) {
		...
		p022_LargestRectangleInHistogram_BruteForce mainClass = new p022_LargestRectangleInHistogram_BruteForce();

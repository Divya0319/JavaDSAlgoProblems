...
public class p005_GetMinimumInOrder1TimeInStack<T> implements DynamicStackService<T>{
	...
	public static void main(String[] args) {
		...
		p005_GetMinimumInOrder1TimeInStack<Integer> mainClass = new p005_GetMinimumInOrder1TimeInStack<>();

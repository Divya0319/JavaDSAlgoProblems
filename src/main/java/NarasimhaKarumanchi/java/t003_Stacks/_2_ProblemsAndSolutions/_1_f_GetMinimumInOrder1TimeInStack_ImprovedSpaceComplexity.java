...
public class _1_f_GetMinimumInOrder1TimeInStack_ImprovedSpaceComplexity<T> implements DynamicStackService<T>{
	...
	public static void main(String[] args) {
		...
		_1_f_GetMinimumInOrder1TimeInStack_ImprovedSpaceComplexity<Integer> mainClass = new _1_f_GetMinimumInOrder1TimeInStack_ImprovedSpaceComplexity<>();

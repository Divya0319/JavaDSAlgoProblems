...
import main.java.NarasimhaKarumanchi.java.t004_Queues.ListNode;
import main.java.NarasimhaKarumanchi.java.t004_Queues.DynamicQueueService;
import main.java.NarasimhaKarumanchi.java.t004_Queues.LinkedStack;

public class p002_QueueUsingTwoStacks<T> implements DynamicQueueService<T> {
	...
	public static void main(String[] args) {
		try {
			p002_QueueUsingTwoStacks<Integer> quts = new p002_QueueUsingTwoStacks<>();
			quts.enQueue(1);

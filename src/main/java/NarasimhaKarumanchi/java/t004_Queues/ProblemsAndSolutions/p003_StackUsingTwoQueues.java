...
import main.java.NarasimhaKarumanchi.java.t004_Queues.StackService;

public class p003_StackUsingTwoQueues<T> implements StackService<T> {
	...
	public static void main(String[] args) {
		p003_StackUsingTwoQueues<Integer> swtq = new p003_StackUsingTwoQueues<>();
		try {
		swtq.push(5);

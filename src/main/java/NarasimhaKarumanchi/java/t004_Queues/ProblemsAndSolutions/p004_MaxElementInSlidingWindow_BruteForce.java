...
public class p004_MaxElementInSlidingWindow_BruteForce {
	...
	public static void main(String[] args) {
		p004_MaxElementInSlidingWindow_BruteForce mainClass = new p004_MaxElementInSlidingWindow_BruteForce();
